...
import { useDataStore, Dashboard, Usuario, Credencial, ParametroRLS, AcessoEspecial } from "@/hooks/useDataStore";

export type { Dashboard, Usuario, Credencial, ParametroRLS, AcessoEspecial };
